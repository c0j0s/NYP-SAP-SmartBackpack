...
sap.ui.define([
	...
	return BaseController.extend("sbp.SmartBackpackAdmin.controller.Detail", {
		...
		onInit: function () {
			...
			//var bindingContext = this.getOwnerComponent().getBindingContext();
			//var userid = bindingContext.getProperty("USER_ID");
			//console.log(userid);
			// var userDeviceTable = this.getView().byId("userDeviceTable");
			// var oFilter = new sap.ui.model.Filter("USER_ID", sap.ui.model.FilterOperator.EQ, '{USER_ID}');
		...
		expandIotDataOverview: function (oEvent) {
			...
			// this.getView().byId("iotDataOverviewPanel").setExpanded(true);
			// this.getView().byId("iotDataLabelInfo").setVisible(false);
			// var iotDataTable = this.getView().byId("iotDataTable");
			// iotDataTable.setVisible(true);
			// iotDataTable.bindItems({
			// 	path: "/iotData",
			// 	template: iotDataTable.getBindingInfo("items").template,
			// 	filters: [new sap.ui.model.Filter("DEVICE_SN", sap.ui.model.FilterOperator.EQ, DEVICE_SN)]
			// });
		}
	});
});