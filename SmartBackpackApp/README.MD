...
# Documentation for SAP Cloud Platform Mobile SDK Implementation
...
- BasicAuthPersistentCredentialStore  
...
__*Details instruction can be found in the official SDK documentation__