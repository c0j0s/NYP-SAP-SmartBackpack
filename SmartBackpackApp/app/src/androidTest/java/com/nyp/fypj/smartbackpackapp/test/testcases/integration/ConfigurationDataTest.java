package com.nyp.fypj.smartbackpackapp.test.testcases.integration;
...
public class ConfigurationDataTest {
    ...
    private static String GOOD_URL = "https://mobile-c49f5a6cb.ap1.hana.ondemand.com/";
    ...
    private static String GOOD_DISC_SVC_DFLT =
            ...
            + "    \"port\": 443,\n"
            + "    \"protocol\": \"https\",\n"
            + "    \"appID\": \"com.nyp.fypj.smartbackpackapp\"\n"
            + "}\n";
