...
import com.nyp.fypj.smartbackpackapp.test.core.AbstractPasscodePage;
    ...
    public class EnterPasscodePage extends AbstractPasscodePage {
        ...
        public void enterPasscode(String passcode) {
            ...
            if (WizardDevice.fromBackground) {
                try {
                    new UiObject(new UiSelector().resourceId("com.nyp.fypj.smartbackpackapp:id/passcode_field")).setText(passcode);
